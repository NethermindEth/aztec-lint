...
| `correctness` | `preview` | `AZTEC035` | `aztec-pack maintainers` | `planned` | `0.5.0` |
...
| `protocol` | `preview` | `AZTEC031`, `AZTEC032`, `AZTEC033` | `aztec-pack maintainers` | `planned` | `0.5.0` |
...
| `soundness` | `preview` | `AZTEC030`, `AZTEC034` | `aztec-pack maintainers` | `planned` | `0.5.0` |
| `soundness` | `experimental` | _none_ | `aztec-pack maintainers` | `unplanned` | `TBD` |

## First-Wave Backlog (ROI)

These are the first-wave accepted lints from `docs/NEW_LINTS.md` and are scheduled as the next implementation set.

| Rule ID | Category | Maturity | Owner | Status | Target Release | Matrix Test Plan |
|---|---|---|---|---|---|---|
| `AZTEC030` | `soundness` | `preview` | `aztec-pack maintainers` | `planned` | `0.5.0` | `positive`, `negative`, `suppressed`, `false_positive_guard` + corpus diagnostic contract |
| `AZTEC031` | `protocol` | `preview` | `aztec-pack maintainers` | `planned` | `0.5.0` | `positive`, `negative`, `suppressed`, `false_positive_guard` |
| `AZTEC032` | `protocol` | `preview` | `aztec-pack maintainers` | `planned` | `0.5.0` | `positive`, `negative`, `suppressed`, `false_positive_guard` |
| `AZTEC033` | `protocol` | `preview` | `aztec-pack maintainers` | `planned` | `0.5.0` | `positive`, `negative`, `suppressed`, `false_positive_guard` |
| `AZTEC034` | `soundness` | `preview` | `aztec-pack maintainers` | `planned` | `0.5.0` | `positive`, `negative`, `suppressed`, `false_positive_guard` + benchmark stress scenario |
| `AZTEC035` | `correctness` | `preview` | `aztec-pack maintainers` | `planned` | `0.5.0` | `positive`, `negative`, `suppressed`, `false_positive_guard` |
